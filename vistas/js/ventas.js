...
if(localStorage.getItem("capturarRango")!=null){
	...
	$("#reportrange span").html(' <i class="far fa-calendar-alt"></i> Rango de Fecha');
}
	...
	$.ajax({
		...
		success: function (respuesta) {
			...
			$(".nuevoProducto").append(
				...
				'<span class="input-group-addon"><button type="button" class="btn btn-danger btn-ls quitarProducto" idProducto="' + idProducto + '"><i class="fa fa-times"></i></button></span>' +
...
$(".formularioVenta").on("change", "input.nuevaCantidadProducto", function () {
	...
	if (Number($(this).val()) > Number($(this).attr("stock"))) {
		...
		Swal.fire({
			icon: 'error',
			title: 'Oops...La cantidad supera el stock',
...
$("#nuevoMetodoPago").change(function () {
	...
	if (metodo == "Efectivo") {
		...
		$(this).parent().parent().parent().children(".cajasMetodoPago").html(
			...
			'<input type="text" class="form-control" id="nuevoValorEfectivo" placeholder="Recibi" required>' +
...
$(".tablas").on("click", ".btnEliminarVenta", function () {
	...
	Swal.fire({
		...
		if (result.value) {
			window.location = "index.php?ruta=venta&idVenta=" + idVenta;
...
$('#reportrange').daterangepicker(
	...
	function (start, end) {
		...
		window.location = "index.php?ruta=venta&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal;
	}
)
/*=============================================
